...
export const AdminInstalacoes: React.FC = () => {
  ...
  const installations = licenses
    ...
    .map(l => ({
      ...
      nomePC: l.hostname || `PC-${l.nif.slice(-4)}`,
      so: 'Windows 11 / 10 Pro',
      versao: 'v2026.08.14',
      ultimaAtividade: (l.updated_at || l.activated_at) ? new Date((l.updated_at || l.activated_at)!).toLocaleDateString('pt-AO') : 'Online Cloud',
