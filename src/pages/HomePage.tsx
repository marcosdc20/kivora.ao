          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7 max-w-5xl mx-auto items-stretch">
            ...
            <div className="surface-card p-8 flex flex-col justify-between group">
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-950 mt-1 group-hover:text-[#1746A2] transition-colors">Plano Mensal</h3>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-slate-100 hover:bg-[#1746A2] hover:text-white text-slate-900 font-bold text-xs transition-all cursor-pointer"
              >
                Aderir ao Plano Mensal
              </button>
            </div>

            {/* 2. Anual Comercial LAN (Destaque com Azul Sólido Corporativo) */}
            <div className="bg-[#1746A2] border-2 border-blue-400 rounded-3xl p-8 flex flex-col justify-between shadow-xl relative scale-102 z-10 text-white">
              {/* Badge Não Cortado */}
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#FF6500] text-white text-[10px] font-black uppercase px-4 py-1.5 rounded-full tracking-wider shadow-md whitespace-nowrap z-20">
                ⭐ Mais Escolhido em Angola
              </div>

              <div className="relative z-10 pt-2">
                <span className="text-xs font-bold text-blue-200 uppercase tracking-wider">Multi-Postos & Rede LAN</span>
                <h3 className="text-xl font-bold text-white mt-1">Plano Anual LAN</h3>
                <div className="mt-4 mb-6">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-white hover:bg-slate-100 text-[#1746A2] font-bold text-xs transition-all shadow-md cursor-pointer relative z-10"
              >
            ...
            <div className="surface-card p-8 flex flex-col justify-between group">
              <div>
                <span className="text-xs font-bold text-amber-700 uppercase tracking-wider">Pagamento Único</span>
                <h3 className="text-xl font-bold text-slate-950 mt-1 group-hover:text-amber-700 transition-colors">Licença Vitalícia</h3>
                <div className="mt-4 mb-6">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-amber-50 hover:bg-amber-600 hover:text-white text-amber-800 font-bold text-xs transition-all cursor-pointer border border-amber-200 hover:border-amber-600"
              >
