...
export const DEMO_ACCOUNTS: DemoAccount[] = [
  {
    ...
    image: '/imagens/2147663610.jpg',
    session: {
      id: 'usr-admin-01',
      name: 'Dr. Adelino Costa',
      email: 'admin@kivora.ao',
      role: 'admin',
      avatar: '/imagens/2147663610.jpg',
  ...
  },
  {
    ...
    session: {
      ...
      email: 'utilizador@kivora.ao',
      role: 'student',
      avatar: '/imagens/2149272217.jpg',
      title: 'Utilizador Nível Avançado',
      grade: '10ª Classe',
  ...
  },
  {
    ...
    session: {
      ...
      email: 'encarregado@kivora.ao',
      role: 'guardian',
      avatar: '/imagens/2151696448.jpg',
      title: 'Encarregada de Conta',
      studentId: 'aluno-001',
      schoolName: 'Kivora Angola – Luanda',
    }
  }
