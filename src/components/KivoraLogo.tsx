...
export const KivoraLogo: React.FC<KivoraLogoProps> = ({
  ...
  const sizeMap = {
    ...
    md: { icon: 40, text: 'text-xl md:text-2xl', subText: 'text-[9px] md:text-[10px]' },
    lg: { icon: 52, text: 'text-2xl md:text-3xl', subText: 'text-[11px]' },
    xl: { icon: 64, text: 'text-3xl md:text-4xl', subText: 'text-xs' },
  };
        ...
        <g>
          ...
          <path
            d="M 45 25 
               C 45 10, 65 10, 80 25 
               L 80 145 
               L 74 150 L 68 145 L 62 150 L 56 145 L 50 150 L 45 145 Z"
            fill="url(#kivoraBlueStem)"
          />
          
          {/* Inner Document White Sheet */}
          <path
